...
def extrair_video_shopee(url):
    ...
    - br.shp.ee (links encurtados)
    - universal-link?redir=
    - share-video/ID
    - fallback MP4/M3U8/JSON
    """
    # 1) Resolver link encurtado br.shp.ee
    ...
    # 4) tentar API oficial da Shopee
